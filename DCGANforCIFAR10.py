# -*- coding: utf-8 -*-
"""
Much of this code is borrowed from https://github.com/Ksuryateja/DCGAN-CIFAR10-pytorch

A Deep Convolutional GAN (DCGAN) is implemented to generate images from the CIFAR-10
dataset and uses:
▪ Strided convolutions instead of pooling layers.
▪ Batch normalization in both the generator and the discriminator.
▪ The ReLU activation function in the generator and Leaky ReLU in the discriminator.

The generated images are can be visualized and compared them to the real CIFAR-10 images.

Latent space interpolation is also shown at the end
