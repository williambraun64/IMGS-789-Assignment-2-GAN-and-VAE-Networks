# -*- coding: utf-8 -*-
"""
A GAN to generate images from the MNIST dataset. Uses a fully connected
generator and discriminator network. Plots of the loss curves for both the
generator and discriminator can be generated.

Outputs of the generator can also be visualized 
"""
