# -*- coding: utf-8 -*-
"""
Some of this code is borrowed from https://avandekleut.github.io/vae/

A Variational Autoencoder (VAE) is implemented on the MNIST dataset.
The reconstructed and the newly generated images are vidualized with plots of the ELBO (Evidence
Lower Bound) loss and KL-divergence during training.

Anomaly detectiuon is also implemented and a threshold can be determine dby comparing reconstruction loss between real and perturbed data.

2D scatter plots of latent vectors are also visualized.
